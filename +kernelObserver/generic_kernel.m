...
%
%============================= rbf_kernel =================================
function [kmat] =  generic_kernel(x,y,k_obj)
...
if strcmpi(k_func,'laplacian') || strcmpi(k_func,'cauchy')...
  ...
  kmat = kernelObserver.rbf_kernel(x,y,k_func,bandwidth);
elseif strcmpi(k_func,'periodic')    
  kmat = kernelObserver.periodic_kernel(x,y,parameters(1),parameters(2)); 
